...
class Compressor
{
	...
	void setParamCompression(Mat imageName);
	void setParamDecompression(Mat imageName);
	...
	void compress(string imageName);//Execute Huffman to create a table of symbols and codify the image to a file
	void decompress(string imageName);
...
void Compressor::setParamCompression(Mat imageName){
...
//Compressor step
void Compressor::compress(Mat imageName){
...
//Uncompress step
void Compressor::decompress(string fileName){
	//Just for information
	//cout << "\nUncompressing...";
